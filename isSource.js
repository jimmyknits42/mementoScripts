...
function deleteAutoGeneratedSourceEntry(e) {
  ...
  //1 - filter to entries linked to parameter
...
message("qryRes1 length = " + qryRes1.length);
...
message("qryRes2 length = " + qryRes2.length);
  //3 - filter the most recently created entry
  entryToDelete = getMaximalEntry(qryRes2, "Timestamp");
message("entryToDelete = " + JSON.stringify(entryToDelete));
